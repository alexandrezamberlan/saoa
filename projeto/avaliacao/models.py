...
class Avaliacao(models.Model):
    ...
    merito_metodologia_responsavel = models.DecimalField('Metodologia: O artigo apresenta uma metodologia e a utiliza de forma apropriada para o problema proposto?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_fundamentacao_responsavel = models.DecimalField('Fundamentação teórica: O artigo baseia-se em teorias, fundamentos e conceitos relevantes na área em que foi submetido ao evento?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_clareza_responsavel = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_responsavel = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    ...
    merito_fundamentacao_suplente = models.DecimalField('Fundamentação teórica: O artigo baseia-se em teorias, fundamentos e conceitos relevantes na área em que foi submetido ao evento?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_clareza_suplente = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_suplente = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    ...
    merito_fundamentacao_convidado = models.DecimalField('Fundamentação teórica: O artigo baseia-se em teorias, fundamentos e conceitos relevantes na área em que foi submetido ao evento?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_clareza_convidado = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_convidado = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ',help_text='De 0 a 5', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text=' Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
