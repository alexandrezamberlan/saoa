...
class Avaliacao(models.Model):
    ...
    merito_clareza_responsavel = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_responsavel = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_resultados_responsavel = models.DecimalField('Resultados e discussões: Os resultados são apresentados e discutidos adequadamente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_conclusao_responsavel = models.DecimalField('Conclusões: O trabalho traz considerações finais ou conclusão, apresentando reflexões,  avanços ou soluções ao tema abordado, conforme os objetivos propostos?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    
    # merito_desenvolvimento_responsavel = models.DecimalField('Desenvolvimento', max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_redacao_responsavel = models.DecimalField('Redação do texto', max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_apresentacao_responsavel = models.DecimalField('Apresentação', max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    
    nota_final_responsavel = models.DecimalField('Final Avaliador 1', max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)    
    ...
    merito_relevancia_suplente = models.DecimalField('Relevância: O artigo aborda um problema atual e/ou relevante na área em que foi submetido ao evento?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_contribuicao_suplente = models.DecimalField('Contribuição: O trabalho apresenta contribuição para a área em que foi submetido ao evento?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_metodologia_suplente = models.DecimalField('Metodologia: O artigo apresenta uma metodologia e a utiliza de forma apropriada para o problema proposto?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_fundamentacao_suplente = models.DecimalField('Fundamentação teórica: O artigo baseia-se em teorias, fundamentos e conceitos relevantes na área em que foi submetido ao evento?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_clareza_suplente = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_suplente = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_resultados_suplente = models.DecimalField('Resultados e discussões: Os resultados são apresentados e discutidos adequadamente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_conclusao_suplente = models.DecimalField('Conclusões: O trabalho traz considerações finais ou conclusão, apresentando reflexões,  avanços ou soluções ao tema abordado, conforme os objetivos propostos?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    
    # merito_desenvolvimento_suplente = models.DecimalField('Desenvolvimento', max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_redacao_suplente = models.DecimalField('Redação do texto'), max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_apresentacao_suplente = models.DecimalField('Apresentação'), max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    
    nota_final_suplente = models.DecimalField('Final Avaliador 2',  max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)         
    ...
    merito_contribuicao_convidado = models.DecimalField('Contribuição: O trabalho apresenta contribuição para a área em que foi submetido ao evento?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_metodologia_convidado = models.DecimalField('Metodologia: O artigo apresenta uma metodologia e a utiliza de forma apropriada para o problema proposto?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_fundamentacao_convidado = models.DecimalField('Fundamentação teórica: O artigo baseia-se em teorias, fundamentos e conceitos relevantes na área em que foi submetido ao evento?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_clareza_convidado = models.DecimalField('Clareza e organização: O artigo apresenta escrita clara, organizada e coerente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_referencias_convidado = models.DecimalField('Referências bibliográficas: As referências utilizadas no artigo são atualizadas e/ou relevantes? ', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_resultados_convidado = models.DecimalField('Resultados e discussões: Os resultados são apresentados e discutidos adequadamente?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    merito_conclusao_convidado = models.DecimalField('Conclusões: O trabalho traz considerações finais ou conclusão, apresentando reflexões,  avanços ou soluções ao tema abordado, conforme os objetivos propostos?', max_digits=1, decimal_places=0, validators=[MinValueValidator(0), MaxValueValidator(5)], null=True, blank=True, default = 0, help_text='De 0 a 5. Nota 0 equivale a NÃO atende, enquanto, nota 5 atende COMPLETAMENTE.')
    
    # merito_desenvolvimento_convidado = models.DecimalField('Desenvolvimento'), max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_redacao_convidado = models.DecimalField('Redação do texto'), max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    # merito_apresentacao_convidado = models.DecimalField('Apresentação'), max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)
    
    nota_final_convidado = models.DecimalField('Final Avaliador 3',  max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True, default = 0)         
    ...
    media_final_avaliacao = models.DecimalField('Média Final', default = 0, max_digits=4, decimal_places=1, validators=[MinValueValidator(0.0), MaxValueValidator(10)], null=True, blank=True)    
