...
class Submissao(models.Model): 
    ...
    resumo = models.TextField('Resumo *', max_length=1000, help_text='Se for colar texto de outro aplicativo, certifique-se que o resumo esteja completo')
    abstract = models.TextField('Abstract *', max_length=1000, help_text='Se for colar texto de outro aplicativo, certifique-se que o abstract esteja completo')
